...
public class ELFPlugin extends AbstractUnitIdentifier {
	...
	public PluginInformation getPluginInformation() {
		return new PluginInformation("ELF File Unit",
				"Linux ELF parser plugin", "1.0", "PNF Software");
	}
	...
	public boolean canIdentify(IInput input, IUnitCreator parent) {
		return checkBytes(input, 0, (int) ELF.ElfMagic[0],
				(int) ELF.ElfMagic[1], (int) ELF.ElfMagic[2],
				(int) ELF.ElfMagic[3])
				&&

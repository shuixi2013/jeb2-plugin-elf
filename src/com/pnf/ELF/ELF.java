...
public class ELF {
	...
	public static int relocate(int id, int A, int ABitCount, int AHL, int P,
			int S, int G, int GP, int GP0, int EA, int L, R_SYMBOL sym) {
		...
		throw new RuntimeException(String.format(
				"Relocation type %d not recognized. Please add it", id));
	}
